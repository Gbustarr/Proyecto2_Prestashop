<?php
/* Smarty version 4.3.4, created on 2024-06-15 16:53:31
  from 'module:ps_imagesliderviewstemplateshookslider.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_666dff4badfab7_65213029',
...
function content_666dff4badfab7_65213029 (Smarty_Internal_Template $_smarty_tpl) {
?>
  <div id="carousel" data-ride="carousel" class="carousel slide" data-interval="5000" data-wrap="true" data-pause="hover" data-touch="true">
    ...
    <ul class="carousel-inner" role="listbox" aria-label="Contenedor carrusel ">
              <li class="carousel-item active" role="option" aria-hidden="false">
                      <figure>
              <img src="http://localhost/modules/ps_imageslider/images/5cc0ef2077ce9959f0c5a454772bc9639a5feba3_back-slide1.jpeg" alt="LO MEJOR DE LO MEJOR" loading="lazy" width="1110" height="340">
          ...
          <a href="https://www.prestashop-project.org">            <figure>
              <img src="http://localhost/modules/ps_imageslider/images/56f4d9ea6dd9cc59b5b1c540fa0a0be6db498dff_back-slide2.jpeg" alt="Tienda de Tecnologia" loading="lazy" width="1110" height="340">
                              <figcaption class="caption">
                  <h2 class="display-1 text-uppercase">SCRAPY-TEK</h2>
...
<p>"Nunca había estado tan satisfecha en la compra de productos online hasta que me topé con esta pagina maravillosa"</p></div>
              ...
              <li class="carousel-item " role="option" aria-hidden="true">
          <a href="https://www.prestashop-project.org">            <figure>
              <img src="http://localhost/modules/ps_imageslider/images/92dc221c8ea12d1a935e4024996aef388823900d_back-slide3.jpeg" alt="O-MY-GOD" loading="lazy" width="1110" height="340">
                              <figcaption class="caption">
                  <h2 class="display-1 text-uppercase">SCRAPY-TEK</h2>
